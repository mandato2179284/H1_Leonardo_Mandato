...
#include <stdio.h> // Per FILE*, fopen, fgets, etc.
#include <stdlib.h> // Per malloc, realloc, free, etc.
#include <string.h> // Per memset, strncpy, strtok, etc.
#include <ctype.h> // Per isalpha, isalnum, etc.
